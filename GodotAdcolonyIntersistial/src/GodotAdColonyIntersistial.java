...
public class GodotAdColonyIntersistial extends Godot.SingletonBase
{
		...
		activity.runOnUiThread(new Runnable()
		{
			@Override public void run()
			{
		        ...
		        listener = new AdColonyInterstitialListener()
		        {
		            ...
		            {
		                GodotAdColonyIntersistial.this.ad = ad;
	 ...
	 */
 	...
 	{
 		return new GodotAdColonyIntersistial(activity);
 	}
	 ...
	 */
	public GodotAdColonyIntersistial(Activity p_activity) {
		registerClass("AdColonyInterstitial", new String[] {
			"init",
			"loadAd", "showAd"
		});
		activity = p_activity;
